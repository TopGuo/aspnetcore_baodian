...
namespace TB.AspNetCore.Infrastructrue.Auth.MvcAuth
{
    public class MvcCookieAuthenticationHandler : CookieAuthenticationHandler
    {
        ...
        public MvcCookieAuthenticationHandler(IOptions<MvcApplicationOptions> mvcApplicationOptions, IOptionsMonitor<CookieAuthenticationOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
        ...
        protected override async Task HandleForbiddenAsync(AuthenticationProperties properties)
        {
            ...
            string accessDeniedUri = string.Concat((object)deniedPath, (object)QueryString.Create(returnParameter, returnUrl));
        ...
        protected override async Task HandleChallengeAsync(AuthenticationProperties properties)
        {
            ...
            PathString? nullable = (PathString?)schemes?.LoginPath;
            ...
            string loginUri = string.Concat((object)path, (object)QueryString.Create(returnParameter, redirectUri));
        ...
        protected new string BuildRedirectUri(string targetPath)
        {
            ...
            return string.Concat((object)base.Request.Scheme, (object)"://", (object)base.Request.Host) + base.OriginalPathBase + targetPath;
        }
    }
}
